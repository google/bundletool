...
/** Indicates failure in ABD command. */
public class AdbOutputParseException extends CommandExecutionException {

  public AdbOutputParseException(String userMessage, String internalMessage, Throwable cause) {
    super(userMessage, internalMessage, cause);
  }
