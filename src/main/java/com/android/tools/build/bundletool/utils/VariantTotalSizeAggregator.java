...
import static com.android.tools.build.bundletool.commands.GetSizeCommand.Dimension.ABI;
import static com.android.tools.build.bundletool.commands.GetSizeCommand.Dimension.LANGUAGE;
import static com.android.tools.build.bundletool.commands.GetSizeCommand.Dimension.SCREEN_DENSITY;
import static com.android.tools.build.bundletool.commands.GetSizeCommand.Dimension.SDK;
import static com.android.tools.build.bundletool.utils.DeviceSpecUtils.isAbiMissing;
import static com.android.tools.build.bundletool.utils.DeviceSpecUtils.isLocalesMissing;
import static com.android.tools.build.bundletool.utils.DeviceSpecUtils.isScreenDensityMissing;
import static com.android.tools.build.bundletool.utils.DeviceSpecUtils.isSdkVersionMissing;
import static com.android.tools.build.bundletool.utils.ResultUtils.isStandaloneApkVariant;
...
import com.android.tools.build.bundletool.utils.DeviceSpecUtils.DeviceSpecFromTargetingBuilder;
