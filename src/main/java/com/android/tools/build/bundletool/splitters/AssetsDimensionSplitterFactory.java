...
public class AssetsDimensionSplitterFactory {
     ...
     * descriptions.
     */
    public static <T extends Message> ModuleSplitSplitter createSplitter(Function<AssetsDirectoryTargeting, T> dimensionGetter, Function<T, ApkTargeting> targetingSetter, Predicate<ApkTargeting> hasTargeting) {
        return createSplitter(dimensionGetter, targetingSetter, hasTargeting, /* targetingDimensionToRemove= */
        Optional.empty());
    }
