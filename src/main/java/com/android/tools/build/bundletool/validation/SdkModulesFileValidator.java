...
/** Validates the RESM archives in ASBs and ASARs. */
public class SdkModulesFileValidator {
  ...
  public void validate(ZipFile modulesFile) {
    new ValidatorRunner(allModulesFileSubValidators).validateSdkModulesZipFile(modulesFile);
  }

  private SdkModulesFileValidator(ImmutableList<SubValidator> allModulesFileSubValidators) {
