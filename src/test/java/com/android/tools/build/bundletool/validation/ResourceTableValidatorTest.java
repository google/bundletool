...
public class ResourceTableValidatorTest {
    ...
    public void validateModule_validWithoutResources_succeeds() throws Exception {
        BundleModule module = new BundleModuleBuilder("module").addFile("assets/file.txt").setManifest(androidManifest("com.test.app")).build();
    ...
    public void validateModule_nonExistingResourceTable_throws() throws Exception {
        BundleModule module = new BundleModuleBuilder("module").addFile("res/drawable/icon.png").setManifest(androidManifest("com.test.app")).build();
        InvalidBundleException exception = assertThrows(InvalidBundleException.class, () -> new ResourceTableValidator().validateModule(module));
        assertThat(exception).hasMessageThat().contains("contains resource files but is missing a resource table");
    }
    ...
    public void duplicateResourceId_sameModule_throws() throws Exception {
        BundleModule module = new BundleModuleBuilder("base").setResourceTable(resourceTable(pkg(USER_PACKAGE_OFFSET, "com.test.app", type(0x01, "drawable", entry(0x0002, "logo"), entry(0x0002, "logo2"))))).setManifest(androidManifest("com.test.app")).build();
        InvalidBundleException exception = assertThrows(InvalidBundleException.class, () -> new ResourceTableValidator().checkResourceIds(ImmutableList.of(module)));
    ...
    public void duplicateResourceId_isolatedSplits_sameModule_throws() throws Exception {
        BundleModule module = new BundleModuleBuilder("base").setResourceTable(resourceTable(pkg(USER_PACKAGE_OFFSET, "com.test.app", type(0x01, "drawable", entry(0x0002, "logo"), entry(0x0002, "logo2"))))).setManifest(androidManifest("com.test.app", withIsolatedSplits(true))).build();
        InvalidBundleException exception = assertThrows(InvalidBundleException.class, () -> new ResourceTableValidator().checkResourceIds(ImmutableList.of(module)));
        assertThat(exception).hasMessageThat().contains("Duplicate resource");
    }
    ...
    public void duplicateResourceId_isolatedSplits_differentModule_doesNotThrow() throws Exception {
        BundleModule baseModule = new BundleModuleBuilder("base").setResourceTable(resourceTable(pkg(USER_PACKAGE_OFFSET, "com.test.app", type(0x01, "drawable", entry(0x0002, "logo"))))).setManifest(androidManifest("com.test.app", withIsolatedSplits(true))).build();
        BundleModule secondModule = new BundleModuleBuilder("secondModule").setResourceTable(resourceTable(pkg(USER_PACKAGE_OFFSET, "com.test.app", type(0x01, "drawable", entry(0x0002, "logo"))))).setManifest(androidManifest("com.test.app", withFusingAttribute(false))).build();
    ...
    public void duplicateResourceId_isolatedSplits_sameModuleWithoutFusing_throws() throws Exception {
        BundleModule baseModule = new BundleModuleBuilder("base").setManifest(androidManifest("com.test.app", withIsolatedSplits(true))).build();
        BundleModule secondModule = new BundleModuleBuilder("secondModule").setResourceTable(resourceTable(pkg(USER_PACKAGE_OFFSET, "com.test.app", type(0x01, "drawable", entry(0x0002, "logo"), entry(0x0002, "logo2"))))).setManifest(androidManifest("com.test.app", withFusingAttribute(false))).build();
        InvalidBundleException exception = assertThrows(InvalidBundleException.class, () -> new ResourceTableValidator().checkResourceIds(ImmutableList.of(baseModule, secondModule)));
        assertThat(exception).hasMessageThat().contains("Duplicate resource");
    }

    @Test
    public void duplicateResourceId_isolatedSplits_differentModuleWithFusing_throws() throws Exception {
        BundleModule baseModule = new BundleModuleBuilder("base").setResourceTable(resourceTable(pkg(USER_PACKAGE_OFFSET, "com.test.app", type(0x01, "drawable", entry(0x0002, "logo"))))).setManifest(androidManifest("com.test.app", withIsolatedSplits(true))).build();
        BundleModule secondModule = new BundleModuleBuilder("secondModule").setResourceTable(resourceTable(pkg(USER_PACKAGE_OFFSET, "com.test.app", type(0x01, "drawable", entry(0x0002, "logo"))))).setManifest(androidManifest("com.test.app", withFusingAttribute(true))).build();
        InvalidBundleException exception = assertThrows(InvalidBundleException.class, () -> new ResourceTableValidator().checkResourceIds(ImmutableList.of(baseModule, secondModule)));
        assertThat(exception).hasMessageThat().contains("Duplicate resource");
    }
    ...
    public void noResourceTable_doesNotThrow() throws Exception {
        BundleModule module = new BundleModuleBuilder("base").setResourceTable(resourceTable()).setManifest(androidManifest("com.test.app")).build();
    ...
    public void nonDuplicateResources_sameModule_doesNotThrow() throws Exception {
        BundleModule module = new BundleModuleBuilder("base").setResourceTable(resourceTable(pkg(USER_PACKAGE_OFFSET, "com.test.app", type(0x01, "drawable", entry(0x0002, "logo"), entry(0x0003, "logo2"))))).setManifest(androidManifest("com.test.app")).build();
        new ResourceTableValidator().checkResourceIds(ImmutableList.of(module));
    }
    ...
    public void nonDuplicateResources_differentModule_doesNotThrow() throws Exception {
        BundleModule firstModule = new BundleModuleBuilder("base").setResourceTable(resourceTable(pkg(USER_PACKAGE_OFFSET, "com.test.app", type(0x01, "drawable", entry(0x0002, "logo"))))).setManifest(androidManifest("com.test.app")).build();
        BundleModule secondModule = new BundleModuleBuilder("secondModule").setResourceTable(resourceTable(pkg(USER_PACKAGE_OFFSET, "com.test.app", type(0x01, "drawable", entry(0x0003, "logo"))))).setManifest(androidManifest("com.test.app")).build();
