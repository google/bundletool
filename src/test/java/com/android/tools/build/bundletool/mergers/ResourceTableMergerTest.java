...
public class ResourceTableMergerTest {
    ...
    public void packagesWithDifferentIds_concatenated() throws Exception {
        ...
        ResourceTable merged = new ResourceTableMerger().merge(table1, table2);
        assertThat(merged).ignoringRepeatedFieldOrder().isEqualTo(resourceTable(pkg(0x01, "package01"), pkg(0x02, "package02")));
    }
    ...
    public void typesWithMatchingIds_merged() throws Exception {
        ...
        ResourceTable merged = new ResourceTableMerger().merge(table1, table2);
        assertThat(merged).ignoringRepeatedFieldOrder().isEqualTo(resourceTable(pkg(0x01, "package", type(0x11, "type"))));
    }
    ...
    public void typesWithDifferentIds_concatenated() throws Exception {
        ...
        ResourceTable merged = new ResourceTableMerger().merge(table1, table2);
        assertThat(merged).ignoringRepeatedFieldOrder().isEqualTo(resourceTable(pkg(0x01, "package", type(0x11, "type1"), type(0x12, "type2"))));
    }

    @Test
    public void entriesWithMatchingIds_merged() throws Exception {
        ResourceTable table1 = resourceTable(pkg(0x01, "package", type(0x11, "type", entry(0x21, "entry"))));
        ResourceTable table2 = resourceTable(pkg(0x01, "package", type(0x11, "type", entry(0x21, "entry"))));
        ResourceTable merged = new ResourceTableMerger().merge(table1, table2);
        assertThat(merged).ignoringRepeatedFieldOrder().isEqualTo(resourceTable(pkg(0x01, "package", type(0x11, "type", entry(0x21, "entry")))));
    }

    @Test
    public void entriesWithDifferentIds_concatenated() throws Exception {
        ResourceTable table1 = resourceTable(pkg(0x01, "package", type(0x11, "type", entry(0x21, "entry1"))));
        ResourceTable table2 = resourceTable(pkg(0x01, "package", type(0x11, "type", entry(0x22, "entry2"))));
        ResourceTable merged = new ResourceTableMerger().merge(table1, table2);
        assertThat(merged).ignoringRepeatedFieldOrder().isEqualTo(resourceTable(pkg(0x01, "package", type(0x11, "type", entry(0x21, "entry1"), entry(0x22, "entry2")))));
    }

    @Test
    public void uniqueConfigValues_concatenated() throws Exception {
        ResourceTable table1 = resourceTable(pkg(0x01, "package", type(0x11, "type", entry(0x21, "entry", value("ldpi", LDPI)))));
        ResourceTable table2 = resourceTable(pkg(0x01, "package", type(0x11, "type", entry(0x21, "entry", value("mdpi", MDPI)))));
        ResourceTable merged = new ResourceTableMerger().merge(table1, table2);
        assertThat(merged).ignoringRepeatedFieldOrder().isEqualTo(resourceTable(pkg(0x01, "package", type(0x11, "type", entry(0x21, "entry", value("ldpi", LDPI), value("mdpi", MDPI))))));
    }

    @Test
    public void duplicateConfigValues_deduplicated() throws Exception {
        ResourceTable table1 = resourceTable(pkg(0x01, "package", type(0x11, "type", entry(0x21, "entry", value("ldpi", LDPI)))));
        ResourceTable table2 = resourceTable(pkg(0x01, "package", type(0x11, "type", entry(0x21, "entry", value("ldpi", LDPI)))));
        ResourceTable merged = new ResourceTableMerger().merge(table1, table2);
        assertThat(merged).ignoringRepeatedFieldOrder().isEqualTo(resourceTable(pkg(0x01, "package", type(0x11, "type", entry(0x21, "entry", value("ldpi", LDPI))))));
    }
    ...
    public void sourcePools_different_okAndSourcePoolOfFirstTablePreserved() throws Exception {
        ...
        ResourceTable table2 = table1.toBuilder().setSourcePool(StringPool.newBuilder().setData(ByteString.copyFrom(TEST_BYTES))).build();
        ResourceTable merged = new ResourceTableMerger().merge(table1, table2);
    ...
    public void sourcePools_different_sourceReferencesInSecondTableStripped() throws Exception {
        ...
        ResourceTable table2 = resourceTable(StringPool.newBuilder().setData(ByteString.copyFrom(TEST_BYTES)).build(), pkg(0x02, "package", type(0x11, "type", entry(0x21, "entry", value("ldpi", LDPI, source2)))));
        ResourceTable merged = new ResourceTableMerger().merge(table1, table2);
    ...
    public void sourcePools_equal_sourceReferencesPreserved() throws Exception {
        StringPool commonSourcePool = StringPool.newBuilder().setData(ByteString.copyFrom(TEST_BYTES)).build();
        Source source1 = Source.newBuilder().setPathIdx(42).build();
        Source source2 = Source.newBuilder().setPathIdx(24).build();
    ...
    public void packageNames_different_throws() throws Exception {
        ...
        Throwable exception = assertThrows(IllegalStateException.class, () -> new ResourceTableMerger().merge(table1, table2));
    ...
    public void entryNames_different_throws() throws Exception {
        ResourceTable table1 = resourceTable(pkg(0x01, "com.test.app", type(0x11, "strings", entry(0x21, "nameA"))));
        ResourceTable table2 = resourceTable(pkg(0x01, "com.test.app", type(0x11, "strings", entry(0x21, "nameB"))));
        Throwable exception = assertThrows(IllegalStateException.class, () -> new ResourceTableMerger().merge(table1, table2));
        assertThat(exception).hasMessageThat().contains("Expected same values of field 'name'");
    }
    ...
    public void entryVisibilities_different_throws() throws Exception {
        ...
        Entry entryB = entryA.toBuilder().setVisibility(Visibility.newBuilder().setComment("difference")).build();
    ...
    public void entryAllowNew_different_throws() throws Exception {
        Entry entryA = entry(0x21, "name");
        Entry entryB = entryA.toBuilder().setAllowNew(AllowNew.newBuilder().setComment("difference")).build();
        ResourceTable table1 = resourceTable(pkg(0x01, "com.test.app", type(0x11, "strings", entryA)));
        ResourceTable table2 = resourceTable(pkg(0x01, "com.test.app", type(0x11, "strings", entryB)));
        Throwable exception = assertThrows(IllegalStateException.class, () -> new ResourceTableMerger().merge(table1, table2));
    ...
    public void entryOverlayable_presentAndEqual_okAndPreserved() throws Exception {
        ...
        assertThat(merged.getPackage(0).getType(0).getEntry(0).getOverlayableItem()).isEqualTo(overlayable);
    }

    @Test
    public void entryOverlayable_different_throws() throws Exception {
        Entry entryA = entry(0x21, "name");
        Entry entryB = entryA.toBuilder().setOverlayableItem(OverlayableItem.newBuilder().setComment("comment")).build();
        ResourceTable table1 = resourceTable(pkg(0x01, "com.test.app", type(0x11, "strings", entryA)));
        ResourceTable table2 = resourceTable(pkg(0x01, "com.test.app", type(0x11, "strings", entryB)));
        Throwable exception = assertThrows(IllegalStateException.class, () -> new ResourceTableMerger().merge(table1, table2));
        assertThat(exception).hasMessageThat().contains("Expected same values of field 'overlayable_item'");
    }

    @Test
    public void stripSourceReferences_noSourceReferences_unchanged() throws Exception {
        ResourceTable withoutSource = resourceTable(pkg(0x01, "package", type(0x11, "type", entry(0x21, "entry", value("ldpi", LDPI)))));
    ...
    public void mergeOverlayables_sameOverlayables() throws Exception {
        ResourceTable table = resourceTable(pkg(0x7f, "com.app", type(0x01, "xml", entry(0x00, "layout1", ConfigValue.getDefaultInstance()).toBuilder().setOverlayableItem(newOverlayableItem(/* idx= */
        0)).build(), entry(0x01, "layout2", ConfigValue.getDefaultInstance()).toBuilder().setOverlayableItem(newOverlayableItem(/* idx= */
        1)).build()))).toBuilder().addOverlayable(Overlayable.newBuilder().setName("overlayable1").setActor("actor1")).addOverlayable(Overlayable.newBuilder().setName("overlayable2").setActor("actor2")).build();
    ...
    public void mergeOverlayables_sameNameDifferentActor_throws() throws Exception {
        ResourceTable baseResourceTable = resourceTable(pkg(0x7f, "com.app", type(0x01, "xml", entry(0x00, "layout1", ConfigValue.getDefaultInstance()).toBuilder().setOverlayableItem(newOverlayableItem(/* idx= */
        0)).build(), entry(0x01, "layout2", ConfigValue.getDefaultInstance()).toBuilder().setOverlayableItem(newOverlayableItem(/* idx= */
        1)).build())));
        ResourceTable table1 = baseResourceTable.toBuilder().addOverlayable(Overlayable.newBuilder().setName("overlayable1").setActor("actor1")).addOverlayable(Overlayable.newBuilder().setName("overlayable2").setActor("actor2")).build();
        ResourceTable table2 = baseResourceTable.toBuilder().addOverlayable(Overlayable.newBuilder().setName("overlayable1").setActor("foo")).addOverlayable(Overlayable.newBuilder().setName("overlayable2").setActor("bar")).build();
        assertThrows(IllegalStateException.class, () -> new ResourceTableMerger().merge(table1, table2));
    }

    @Test
    public void mergeOverlayables_overlayablesReindexed() throws Exception {
        Function<Integer, ResourceTable> buildResourceTable = pkgId -> resourceTable(pkg(pkgId, "com.app", type(0x01, "xml", entry(0x00, "layout1", ConfigValue.getDefaultInstance()).toBuilder().setOverlayableItem(newOverlayableItem(/* idx= */
        0)).build(), entry(0x01, "layout2", ConfigValue.getDefaultInstance()).toBuilder().setOverlayableItem(newOverlayableItem(/* idx= */
        1)).build())));
        ResourceTable table1 = buildResourceTable.apply(0x7f).toBuilder().addOverlayable(Overlayable.newBuilder().setName("c").setActor("actor_c")).addOverlayable(Overlayable.newBuilder().setName("a").setActor("actor_a")).build();
        ResourceTable table2 = buildResourceTable.apply(0x7e).toBuilder().addOverlayable(Overlayable.newBuilder().setName("d").setActor("actor_d")).addOverlayable(Overlayable.newBuilder().setName("b").setActor("actor_b")).build();
        ResourceTable mergedTable = new ResourceTableMerger().merge(table1, table2);
        assertThat(mergedTable).isEqualTo(resourceTable(pkg(0x7e, "com.app", type(0x01, "xml", entry(0x00, "layout1", ConfigValue.getDefaultInstance()).toBuilder().setOverlayableItem(newOverlayableItem(/* idx= */
        3)).build(), entry(0x01, "layout2", ConfigValue.getDefaultInstance()).toBuilder().setOverlayableItem(newOverlayableItem(/* idx= */
        1)).build())), pkg(0x7f, "com.app", type(0x01, "xml", entry(0x00, "layout1", ConfigValue.getDefaultInstance()).toBuilder().setOverlayableItem(newOverlayableItem(/* idx= */
        2)).build(), entry(0x01, "layout2", ConfigValue.getDefaultInstance()).toBuilder().setOverlayableItem(newOverlayableItem(/* idx= */
        0)).build()))).toBuilder().addOverlayable(Overlayable.newBuilder().setName("a").setActor("actor_a")).addOverlayable(Overlayable.newBuilder().setName("b").setActor("actor_b")).addOverlayable(Overlayable.newBuilder().setName("c").setActor("actor_c")).addOverlayable(Overlayable.newBuilder().setName("d").setActor("actor_d")).build());
    }
