...
public class ApkComponentTest {
    ...
    public void apkComponent_resource() {
        ...
        assertThat(ApkComponent.fromEntryName("res/drawable-anydpi/splash.xml")).isEqualTo(ApkComponent.RESOURCES);
    }
    ...
    public void apkComponent_nativeLibs() {
        assertThat(ApkComponent.fromEntryName("lib/armeabi/libnoname.so")).isEqualTo(ApkComponent.NATIVE_LIBS);
    }
