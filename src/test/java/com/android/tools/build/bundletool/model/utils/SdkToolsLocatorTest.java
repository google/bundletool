...
public final class SdkToolsLocatorTest {
    ...
    public static final class AdbInSdkDirTest {
        ...
        public static Collection<Object[]> data() {
            return Arrays.asList(new Object[][] { { "Unix", Configuration.unix(), "/usr/home/android/sdk", "" }, { "Windows", Configuration.windows(), "C:\\android\\sdk", ".exe" }, { "OS X", Configuration.osX(), "/Users/home/android/sdk", "" } });
        }
        ...
        public void setUp() throws Exception {
            ...
            platformToolsDir = Files.createDirectories(fileSystem.getPath(sdkPath).resolve(PLATFORM_TOOLS_DIR));
            systemEnvironmentProvider = new FakeSystemEnvironmentProvider(/* variables= */
            ImmutableMap.of(ANDROID_HOME_VARIABLE, Files.createDirectories(fileSystem.getPath(sdkPath)).toString()));
        }

        @Test
        public void locateAdb_found() throws Exception {
            Path expectedAdb = createFileAndParentDirectories(platformToolsDir.resolve(getExecutableName(ADB_FILENAME)));
            Optional<Path> locatedAdb = new SdkToolsLocator(fileSystem).locateAdb(systemEnvironmentProvider);
    ...
    public static final class AdbOnSystemPathTest {
        ...
        @Parameters(name = "os = {0}")
        public static Collection<Object[]> data() {
            return Arrays.asList(new Object[][] { { /* osName */
            "Unix", /* osConfiguration */
            Configuration.unix(), /* pathSeparator */
            ":", /* systemPath */
            "/nonexistent:/bin:\"invalid-path", /* goodPathDir */
            "/bin", /* executableExtension */
            "" }, { /* osName */
            "Windows", /* osConfiguration */
            Configuration.windows(), /* pathSeparator */
            ";", /* systemPath */
            "C:\\nonexistent;C:\\bin;\"invalid-path", /* goodPathDir */
            "C:\\bin", /* executableExtension */
            ".exe" }, { /* osName */
            "Windows ('c:\\adb' dir)", /* osConfiguration */
            Configuration.windows(), /* pathSeparator */
            ";", /* systemPath */
            "C:\\nonexistent;C:\\adb;\"invalid-path", /* goodPathDir */
            "C:\\adb", /* executableExtension */
            ".exe" }, { /* osName */
            "OS X", /* osConfiguration */
            Configuration.osX(), /* pathSeparator */
            ":", /* systemPath */
            "/nonexistent:/bin:\"invalid-path", /* goodPathDir */
            "/bin", /* executableExtension */
            "" } });
        ...
        public void setUp() throws Exception {
            ...
            systemEnvironmentProvider = new FakeSystemEnvironmentProvider(/* variables= */
            ImmutableMap.of(SYSTEM_PATH_VARIABLE, systemPath), /* properties= */
            ImmutableMap.of("path.separator", pathSeparator));
        }

        @Test
        public void locateAdb_found() throws Exception {
            Path expectedAdb = createFileAndParentDirectories(fileSystem.getPath(goodPathDir).resolve(getExecutableName(ADB_FILENAME)));
            Optional<Path> locatedAdb = new SdkToolsLocator(fileSystem).locateAdb(systemEnvironmentProvider);
            assertThat(locatedAdb).hasValue(expectedAdb);
        }
    ...
    public static final class SdkToolsLocatorNotParameterizedTest {
        ...
        public void locateAapt2() throws Exception {
            ...
            Optional<Path> aapt2Path = new SdkToolsLocator(FileSystems.getDefault()).extractAapt2(tempDir);
