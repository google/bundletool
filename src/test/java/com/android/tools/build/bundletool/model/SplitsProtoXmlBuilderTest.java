...
public final class SplitsProtoXmlBuilderTest {
    ...
    public void buildsMultipleModuleEntries_stableOrder() {
        ...
        splitsProtoXmlBuilderDifferentOrder.addLanguageMapping(BundleModuleName.create("b"), "fr", "a.fr");
        splitsProtoXmlBuilderDifferentOrder.addLanguageMapping(BundleModuleName.create("b"), "en", "a.en");
        splitsProtoXmlBuilderDifferentOrder.addLanguageMapping(BundleModuleName.create("a"), "en", "a.en");
        splitsProtoXmlBuilderDifferentOrder.addLanguageMapping(BundleModuleName.create("a"), "fr", "a.fr");
        assertThat(splitsProtoXmlBuilder.build()).isEqualTo(splitsProtoXmlBuilderDifferentOrder.build());
    }
    ...
    public void buildMultipleAssign_throws() {
        ...
        "en", /* splitId = */
        "");
        assertThrows(CommandExecutionException.class, () -> splitsProtoXmlBuilder.addLanguageMapping(BASE_MODULE_NAME, /* language = */
        "ru", /* splitId = */
        "config.ru"));
    }
