...
public class FlagParserTest {
    ...
    public void unknownFlag_throws() throws Exception {
        ...
        UnknownFlagsException e = assertThrows(UnknownFlagsException.class, () -> fp.checkNoUnknownFlags());
    ...
    public void collectorFlag_multipleValues() throws Exception {
        ...
        assertThat(fp.getCommands()).containsExactly("command");
        assertThat(Flag.stringCollector("flag1").getRequiredValue(fp)).containsExactly("v1", "v2").inOrder();
    }
    ...
    public void listFlag_multipleValues() throws Exception {
        ...
        assertThat(Flag.stringList("flag1").getRequiredValue(fp)).containsExactly("v1", "v2", "value3").inOrder();
    }
    ...
    public void pathFlag() throws Exception {
        ...
        assertThat((Object) Flag.path("pathFlag").getRequiredValue(fp)).isEqualTo(Paths.get("/my/path"));
    }
    ...
    public void pathFlag_tildeInPathStart_linux() throws Exception {
        ...
        try {
            ...
            ParsedFlags fp = new FlagParser().parse("command", "--pathFlag=~/my/path");
            assertThat((Object) Flag.path("pathFlag").getRequiredValue(fp)).isEqualTo(Paths.get(System.getProperty("user.home"), "/my/path"));
        } finally {
    ...
    public void passwordFlag_inClearInCommandLine_returnsValue() throws Exception {
        ...
        assertThat(Flag.password("pwdFlag").getRequiredValue(fp).getValue().getPassword()).isEqualTo("hello".toCharArray());
    }
    ...
    public void passwordFlag_inClearInCommandLineWithoutPassPrefix_throws() throws Exception {
        ...
        Throwable exception = assertThrows(IllegalArgumentException.class, () -> Flag.password("pwdFlag").getRequiredValue(fp).getValue());
    ...
    public void parsesCommandLineMixedSeparators() throws Exception {
        ParsedFlags fp = new FlagParser().parse("command", "--flag1", "value1", "--flag2=value2", "--flag3", "value3");
        assertThat(fp.getCommands()).containsExactly("command");
        assertThat(Flag.string("flag1").getRequiredValue(fp)).isEqualTo("value1");
        assertThat(Flag.string("flag2").getRequiredValue(fp)).isEqualTo("value2");
    ...
    public void listFlag_multipleValuesWithSpace() throws Exception {
        ...
        assertThat(Flag.stringList("flag1").getRequiredValue(fp)).containsExactly("v1", "v2", "v3").inOrder();
    }
