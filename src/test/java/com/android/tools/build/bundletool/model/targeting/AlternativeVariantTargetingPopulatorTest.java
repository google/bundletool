...
public class AlternativeVariantTargetingPopulatorTest {
    ...
    public void abi_allVariantsAbiAgnostic_passThrough() throws Exception {
        ...
        ImmutableList<ModuleSplit> outputVariants = new AbiAlternativesPopulator().addAlternativeVariantTargeting(originalSplits);
    ...
    public void screenDensity_allVariantsAbiAgnostic_passThrough() throws Exception {
        ...
        ImmutableList<ModuleSplit> outputVariants = new ScreenDensityAlternativesPopulator().addAlternativeVariantTargeting(originalVariants);
    ...
    public void sdk_allVariantsSdkAgnostic_passThrough() throws Exception {
        ...
        ImmutableList<ModuleSplit> outputVariants = new SdkVersionAlternativesPopulator().addAlternativeVariantTargeting(originalVariants);
        assertThat(originalVariants).isEqualTo(outputVariants);
    }
    ...
    public void sdk_maxSdk_extraAlternativePopulated() {
        ...
        ImmutableList<ModuleSplit> outputVariants = new SdkVersionAlternativesPopulator(/* maxSdkVersion= */
        Optional.of(25)).addAlternativeVariantTargeting(ImmutableList.of(createModuleSplit(lollipopTargeting), createModuleSplit(marshmallowTargeting)));
    ...
    public void sdkRuntimeVariant_correctAlternativeSdkVersionTargetingsPopulated() {
        ...
        ImmutableList<ModuleSplit> postLSplits = ImmutableList.of(createModuleSplit(lPlusTargeting), createModuleSplit(tPlusSdkRuntimeTargeting));
        // 3 density shards.
        ImmutableList<ModuleSplit> standaloneShards = ImmutableList.of(createStandaloneModuleSplit(mergeVariantTargeting(emptySdkTargeting, variantDensityTargeting(DensityAlias.MDPI))), createStandaloneModuleSplit(mergeVariantTargeting(emptySdkTargeting, variantDensityTargeting(DensityAlias.HDPI))), createStandaloneModuleSplit(mergeVariantTargeting(emptySdkTargeting, variantDensityTargeting(DensityAlias.XHDPI))));
        GeneratedApks generatedApks = GeneratedApks.builder().setStandaloneApks(standaloneShards).setSplitApks(postLSplits).build();
        GeneratedApks processedApks = AlternativeVariantTargetingPopulator.populateAlternativeVariantTargeting(generatedApks);
        ...
        assertThat(processedApks.getStandaloneApks().stream().map(ModuleSplit::getVariantTargeting).collect(toImmutableSet())).containsExactly(mergeVariantTargeting(variantSdkTargeting(SdkVersion.getDefaultInstance(), ImmutableSet.of(lPlusVersion)), variantDensityTargeting(DensityAlias.MDPI, ImmutableSet.of(DensityAlias.HDPI, DensityAlias.XHDPI))), mergeVariantTargeting(variantSdkTargeting(SdkVersion.getDefaultInstance(), ImmutableSet.of(lPlusVersion)), variantDensityTargeting(DensityAlias.HDPI, ImmutableSet.of(DensityAlias.MDPI, DensityAlias.XHDPI))), mergeVariantTargeting(variantSdkTargeting(SdkVersion.getDefaultInstance(), ImmutableSet.of(lPlusVersion)), variantDensityTargeting(DensityAlias.XHDPI, ImmutableSet.of(DensityAlias.MDPI, DensityAlias.HDPI))));
        assertThat(processedApks.getSplitApks()).hasSize(2);
        assertThat(processedApks.getSplitApks().stream().map(ModuleSplit::getVariantTargeting).collect(toImmutableSet())).containsExactly(variantSdkTargeting(lPlusVersion, ImmutableSet.of(SdkVersion.getDefaultInstance())), sdkRuntimeVariantTargeting(tPlusVersion));
    }
    ...
    public void multipleSdkRuntimeVariants_correctAlternativeSdkVersionTargetingsPopulated() {
        ...
        ImmutableList<ModuleSplit> postLSplits = ImmutableList.of(createModuleSplit(lPlusTargeting), createModuleSplit(tPlusSdkRuntimeTargeting), createModuleSplit(uPlusTargeting), createModuleSplit(uPlusSdkRuntimeTargeting));
        // 3 density shards.
        ImmutableList<ModuleSplit> standaloneShards = ImmutableList.of(createStandaloneModuleSplit(mergeVariantTargeting(emptySdkTargeting, variantDensityTargeting(DensityAlias.MDPI))), createStandaloneModuleSplit(mergeVariantTargeting(emptySdkTargeting, variantDensityTargeting(DensityAlias.HDPI))), createStandaloneModuleSplit(mergeVariantTargeting(emptySdkTargeting, variantDensityTargeting(DensityAlias.XHDPI))));
        GeneratedApks generatedApks = GeneratedApks.builder().setStandaloneApks(standaloneShards).setSplitApks(postLSplits).build();
        GeneratedApks processedApks = AlternativeVariantTargetingPopulator.populateAlternativeVariantTargeting(generatedApks);
        ...
        assertThat(processedApks.getStandaloneApks()).hasSize(3);
        assertThat(processedApks.getStandaloneApks().stream().map(ModuleSplit::getVariantTargeting).collect(toImmutableSet())).containsExactly(mergeVariantTargeting(variantSdkTargeting(SdkVersion.getDefaultInstance(), ImmutableSet.of(lPlusVersion, uPlusVersion)), variantDensityTargeting(DensityAlias.MDPI, ImmutableSet.of(DensityAlias.HDPI, DensityAlias.XHDPI))), mergeVariantTargeting(variantSdkTargeting(SdkVersion.getDefaultInstance(), ImmutableSet.of(lPlusVersion, uPlusVersion)), variantDensityTargeting(DensityAlias.HDPI, ImmutableSet.of(DensityAlias.MDPI, DensityAlias.XHDPI))), mergeVariantTargeting(variantSdkTargeting(SdkVersion.getDefaultInstance(), ImmutableSet.of(lPlusVersion, uPlusVersion)), variantDensityTargeting(DensityAlias.XHDPI, ImmutableSet.of(DensityAlias.MDPI, DensityAlias.HDPI))));
        assertThat(processedApks.getSplitApks()).hasSize(4);
        assertThat(processedApks.getSplitApks().stream().map(ModuleSplit::getVariantTargeting).collect(toImmutableSet())).containsExactly(variantSdkTargeting(lPlusVersion, ImmutableSet.of(SdkVersion.getDefaultInstance(), uPlusVersion)), variantSdkTargeting(uPlusVersion, ImmutableSet.of(SdkVersion.getDefaultInstance(), lPlusVersion)), sdkRuntimeVariantTargeting(tPlusVersion, ImmutableSet.of(uPlusVersion)), sdkRuntimeVariantTargeting(uPlusVersion, ImmutableSet.of(tPlusVersion)));
    }
    ...
    private static ModuleSplit createModuleSplit(VariantTargeting variantTargeting, SplitType splitType) {
        return ModuleSplit.builder().setAndroidManifest(AndroidManifest.create(androidManifest("com.test.app"))).setEntries(ImmutableList.of()).setMasterSplit(true).setSplitType(splitType).setModuleName(BundleModuleName.create("base")).setApkTargeting(ApkTargeting.getDefaultInstance()).setVariantTargeting(variantTargeting).build();
    }
}
